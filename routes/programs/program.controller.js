...
exports.getOneProgram = (async (req, res) => {
    try {
        ...
        const program = {
            ...
            chapeau_titre: chapeau_titre,
            version_programme: version_programme,
            introduction: introduction,
            chapeau_introduction: chapeau_introduction,
            prix_formation: prix_formation,
            frais_dossier: frais_dossier,
            titre_photo_recto: titre_photo_recto,
            sous_titre_photo_recto: sous_titre_photo_recto,
            titre_footer: titre_footer,
            footer: footer,
            footer_info_sasu: footer_info_sasu,
            intit_objectifs: intit_objectifs,
            cont_objectifs: cont_objectifs,
            intit_duree: intit_duree,
            cont_duree: cont_duree,
            intit_dates: intit_dates,
            cont_dates: cont_dates,
            intit_public: intit_public,
            cont_public: cont_public,
            intit_prerequis: intit_prerequis,
            cont_pre_requis: cont_pre_requis,
            sous_prerequis: sous_prerequis,
            intitule_page_verso: intitule_page_verso,
            chapeau_intitule_verso: chapeau_intitule_verso,
            titre_programme_generique: titre_programme_generique,
            contenu_programme_generique: contenu_programme_generique,
            titre_programme_autre: titre_programme_autre,
            contenu_programme_autre: contenu_programme_autre,
            nom_formateur: nom_formateur,
            metier: metier,
            information_formateur: information_formateur,
            intit_moyens_peda: intit_moyens_peda,
            cont_moyens_peda: cont_moyens_peda,
            intit_accessibilite: intit_accessibilite,
            cont_accessibilite: cont_accessibilite,
            intit_delai: intit_delai,
            cont_delai: cont_delai,
            intit_qualite: intit_qualite,
            cont_qualite: cont_qualite,
            photo_entete_recto: photo_entete_recto,
            photo_cont_recto: photo_cont_recto,
            photo_entete_verso: photo_entete_verso,
            photo_cont_verso: photo_cont_verso,
            logo: logo
        };
